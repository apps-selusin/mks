...
$t03_rkas02_delete = NULL; // Initialize page object first

class ct03_rkas02_delete extends ct03_rkas02 {
	...
	// Page object name
	var $PageObjName = 't03_rkas02_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t03_rkas02list.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t03_rkas02 class, t03_rkas02info.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t03_rkas02list.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t03_rkas02_delete)) $t03_rkas02_delete = new ct03_rkas02_delete();

// Page init
$t03_rkas02_delete->Page_Init();

// Page main
$t03_rkas02_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t03_rkas02_delete->Page_Render();
?>
...
var CurrentForm = ft03_rkas02delete = new ew_Form("ft03_rkas02delete", "delete");

// Form_CustomValidate event
ft03_rkas02delete.Form_CustomValidate = 
...
<?php $t03_rkas02_delete->ShowPageHeader(); ?>
<?php
$t03_rkas02_delete->ShowMessage();
?>
<form name="ft03_rkas02delete" id="ft03_rkas02delete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t03_rkas02_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t03_rkas02_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t03_rkas02">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t03_rkas02_delete->RecKeys as $key) { ?>
...
<?php if ($t03_rkas02->jumlah->Visible) { // jumlah ?>
		<th class="<?php echo $t03_rkas02->jumlah->HeaderCellClass() ?>"><span id="elh_t03_rkas02_jumlah" class="t03_rkas02_jumlah"><?php echo $t03_rkas02->jumlah->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t03_rkas02_delete->RecCnt = 0;
$i = 0;
while (!$t03_rkas02_delete->Recordset->EOF) {
	$t03_rkas02_delete->RecCnt++;
	$t03_rkas02_delete->RowCnt++;

	// Set row properties
	$t03_rkas02->ResetAttrs();
	$t03_rkas02->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t03_rkas02_delete->LoadRowValues($t03_rkas02_delete->Recordset);

	// Render row
	$t03_rkas02_delete->RenderRow();
?>
...
<span id="el<?php echo $t03_rkas02_delete->RowCnt ?>_t03_rkas02_keterangan" class="t03_rkas02_keterangan">
...
<span id="el<?php echo $t03_rkas02_delete->RowCnt ?>_t03_rkas02_jumlah" class="t03_rkas02_jumlah">
...
<?php
	$t03_rkas02_delete->Recordset->MoveNext();
}
$t03_rkas02_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t03_rkas02_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft03_rkas02delete.Init();
</script>
<?php
$t03_rkas02_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t03_rkas02_delete->Page_Terminate();
?>
