...
//
// Table class for t03_rkas02
//
class ct03_rkas02 extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't03_rkas02';
		$this->TableName = 't03_rkas02';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t03_rkas02`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t03_rkas02', 't03_rkas02', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// lv1_id
		$this->lv1_id = new cField('t03_rkas02', 't03_rkas02', 'x_lv1_id', 'lv1_id', '`lv1_id`', '`lv1_id`', 3, -1, FALSE, '`EV__lv1_id`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumlah
		$this->jumlah = new cField('t03_rkas02', 't03_rkas02', 'x_jumlah', 'jumlah', '`jumlah`', '`jumlah`', 4, -1, FALSE, '`jumlah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t03_rkas02`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "t03_rkas02edit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "t03_rkas02add.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t03_rkas02view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t03_rkas02view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t03_rkas02add.php?" . $this->UrlParm($parm);
		else
			$url = "t03_rkas02add.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t03_rkas02edit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t03_rkas02add.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t03_rkas02delete.php", $this->UrlParm());
	}
