...
$t03_rpu_edit = NULL; // Initialize page object first

class ct03_rpu_edit extends ct03_rpu {
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("t03_rpulist.php"); // Return to list page
...
// Create page object
if (!isset($t03_rpu_edit)) $t03_rpu_edit = new ct03_rpu_edit();

// Page init
$t03_rpu_edit->Page_Init();

// Page main
$t03_rpu_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t03_rpu_edit->Page_Render();
?>
...
var CurrentForm = ft03_rpuedit = new ew_Form("ft03_rpuedit", "edit");

// Validate form
ft03_rpuedit.Validate = function() {
...
ft03_rpuedit.Form_CustomValidate = 
...
ft03_rpuedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $t03_rpu_edit->ShowPageHeader(); ?>
<?php
$t03_rpu_edit->ShowMessage();
?>
<?php if (!$t03_rpu_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t03_rpu_edit->Pager)) $t03_rpu_edit->Pager = new cPrevNextPager($t03_rpu_edit->StartRec, $t03_rpu_edit->DisplayRecs, $t03_rpu_edit->TotalRecs, $t03_rpu_edit->AutoHidePager) ?>
<?php if ($t03_rpu_edit->Pager->RecordCount > 0 && $t03_rpu_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t03_rpu_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t03_rpu_edit->PageUrl() ?>start=<?php echo $t03_rpu_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t03_rpu_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t03_rpu_edit->PageUrl() ?>start=<?php echo $t03_rpu_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t03_rpu_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t03_rpu_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t03_rpu_edit->PageUrl() ?>start=<?php echo $t03_rpu_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t03_rpu_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t03_rpu_edit->PageUrl() ?>start=<?php echo $t03_rpu_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t03_rpu_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft03_rpuedit" id="ft03_rpuedit" class="<?php echo $t03_rpu_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t03_rpu_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t03_rpu_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t03_rpu">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($t03_rpu_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($t03_rpu->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_t03_rpu_id" class="<?php echo $t03_rpu_edit->LeftColumnClass ?>"><?php echo $t03_rpu->id->FldCaption() ?></label>
		<div class="<?php echo $t03_rpu_edit->RightColumnClass ?>"><div<?php echo $t03_rpu->id->CellAttributes() ?>>
<span id="el_t03_rpu_id">
<span<?php echo $t03_rpu->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t03_rpu->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t03_rpu" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t03_rpu->id->CurrentValue) ?>">
<?php echo $t03_rpu->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t03_rpu->Level->Visible) { // Level ?>
	<div id="r_Level" class="form-group">
		<label id="elh_t03_rpu_Level" for="x_Level" class="<?php echo $t03_rpu_edit->LeftColumnClass ?>"><?php echo $t03_rpu->Level->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t03_rpu_edit->RightColumnClass ?>"><div<?php echo $t03_rpu->Level->CellAttributes() ?>>
...
<?php if ($t03_rpu->Urutan->Visible) { // Urutan ?>
	<div id="r_Urutan" class="form-group">
		<label id="elh_t03_rpu_Urutan" for="x_Urutan" class="<?php echo $t03_rpu_edit->LeftColumnClass ?>"><?php echo $t03_rpu->Urutan->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t03_rpu_edit->RightColumnClass ?>"><div<?php echo $t03_rpu->Urutan->CellAttributes() ?>>
...
<?php if ($t03_rpu->No_Urut->Visible) { // No_Urut ?>
	<div id="r_No_Urut" class="form-group">
		<label id="elh_t03_rpu_No_Urut" for="x_No_Urut" class="<?php echo $t03_rpu_edit->LeftColumnClass ?>"><?php echo $t03_rpu->No_Urut->FldCaption() ?></label>
		<div class="<?php echo $t03_rpu_edit->RightColumnClass ?>"><div<?php echo $t03_rpu->No_Urut->CellAttributes() ?>>
...
<?php if ($t03_rpu->Keterangan->Visible) { // Keterangan ?>
	<div id="r_Keterangan" class="form-group">
		<label id="elh_t03_rpu_Keterangan" for="x_Keterangan" class="<?php echo $t03_rpu_edit->LeftColumnClass ?>"><?php echo $t03_rpu->Keterangan->FldCaption() ?></label>
		<div class="<?php echo $t03_rpu_edit->RightColumnClass ?>"><div<?php echo $t03_rpu->Keterangan->CellAttributes() ?>>
...
<?php if ($t03_rpu->Volume->Visible) { // Volume ?>
	<div id="r_Volume" class="form-group">
		<label id="elh_t03_rpu_Volume" for="x_Volume" class="<?php echo $t03_rpu_edit->LeftColumnClass ?>"><?php echo $t03_rpu->Volume->FldCaption() ?></label>
		<div class="<?php echo $t03_rpu_edit->RightColumnClass ?>"><div<?php echo $t03_rpu->Volume->CellAttributes() ?>>
...
<?php if ($t03_rpu->Alokasi->Visible) { // Alokasi ?>
	<div id="r_Alokasi" class="form-group">
		<label id="elh_t03_rpu_Alokasi" for="x_Alokasi" class="<?php echo $t03_rpu_edit->LeftColumnClass ?>"><?php echo $t03_rpu->Alokasi->FldCaption() ?></label>
		<div class="<?php echo $t03_rpu_edit->RightColumnClass ?>"><div<?php echo $t03_rpu->Alokasi->CellAttributes() ?>>
...
<?php if ($t03_rpu->Unit_KOS->Visible) { // Unit_KOS ?>
	<div id="r_Unit_KOS" class="form-group">
		<label id="elh_t03_rpu_Unit_KOS" for="x_Unit_KOS" class="<?php echo $t03_rpu_edit->LeftColumnClass ?>"><?php echo $t03_rpu->Unit_KOS->FldCaption() ?></label>
		<div class="<?php echo $t03_rpu_edit->RightColumnClass ?>"><div<?php echo $t03_rpu->Unit_KOS->CellAttributes() ?>>
...
<?php if ($t03_rpu->Jumlah->Visible) { // Jumlah ?>
	<div id="r_Jumlah" class="form-group">
		<label id="elh_t03_rpu_Jumlah" for="x_Jumlah" class="<?php echo $t03_rpu_edit->LeftColumnClass ?>"><?php echo $t03_rpu->Jumlah->FldCaption() ?></label>
		<div class="<?php echo $t03_rpu_edit->RightColumnClass ?>"><div<?php echo $t03_rpu->Jumlah->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $t03_rpu_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t03_rpu_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
