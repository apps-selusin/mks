...
function CurrentProjectID() {
	...
	return "{EC8C353E-21D9-43CE-9845-66794CB3C5CD}";
}
...
function Database_Connecting(&$info) {
	...
	if (ew_CurrentUserIP() == "127.0.0.1" || ew_CurrentUserIP () == ":: 1" || ew_CurrentHost () == "localhost") { // setting koneksi database di komputer localhost
		...
		$info["db"] = "db_mks"; // sesuaikan dengan nama database di komputer localhost
	} elseif (ew_CurrentHost () == "mks.selusin.net") { // setting koneksi database untuk komputer server
		$info["host"] = "mysql.idhostinger.com";  // sesuaikan dengan ip address atau hostname komputer server
		$info["user"] = "u433254588_mks"; // sesuaikan dengan username database di komputer server
		$info["pass"] = "M457r1P 81"; // sesuaikan deengan password database di komputer server
		$info["db"] = "u433254588_mks"; // sesuaikan dengan nama database di komputer server
	}
}
