...
define("EW_PROJECT_NAME", "prj_mks", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'SlXxOSRk3BIMqL2Y', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_mks", "qs" => "`", "qe" => "`");
...
define("EW_AUDIT_TRAIL_TABLE_NAME", "t99_audit_trail", TRUE); // Audit trail table name
define("EW_AUDIT_TRAIL_TABLE_VAR", "t99_audit_trail", TRUE); // Audit trail table var
