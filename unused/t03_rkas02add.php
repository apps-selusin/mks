...
$t03_rkas02_add = NULL; // Initialize page object first

class ct03_rkas02_add extends ct03_rkas02 {
	...
	// Page object name
	var $PageObjName = 't03_rkas02_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("t03_rkas02list.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t03_rkas02view.php")
	...
	function AddRow($rsold = NULL) {
		...
		// lv1_id
		$this->lv1_id->SetDbValueDef($rsnew, $this->lv1_id->CurrentValue, 0, FALSE);
...
// Create page object
if (!isset($t03_rkas02_add)) $t03_rkas02_add = new ct03_rkas02_add();

// Page init
$t03_rkas02_add->Page_Init();

// Page main
$t03_rkas02_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t03_rkas02_add->Page_Render();
?>
...
var CurrentForm = ft03_rkas02add = new ew_Form("ft03_rkas02add", "add");

// Validate form
ft03_rkas02add.Validate = function() {
...
ft03_rkas02add.Form_CustomValidate = 
...
ft03_rkas02add.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ft03_rkas02add.Lists["x_lv1_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_urut","x_keterangan","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t02_rkas01"};
ft03_rkas02add.Lists["x_lv1_id"].Data = "<?php echo $t03_rkas02_add->lv1_id->LookupFilterQuery(FALSE, "add") ?>";
ft03_rkas02add.AutoSuggests["x_lv1_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $t03_rkas02_add->lv1_id->LookupFilterQuery(TRUE, "add"))) ?>;
...
<?php $t03_rkas02_add->ShowPageHeader(); ?>
<?php
$t03_rkas02_add->ShowMessage();
?>
<form name="ft03_rkas02add" id="ft03_rkas02add" class="<?php echo $t03_rkas02_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t03_rkas02_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t03_rkas02_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t03_rkas02">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($t03_rkas02_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($t03_rkas02->lv1_id->Visible) { // lv1_id ?>
	<div id="r_lv1_id" class="form-group">
		<label id="elh_t03_rkas02_lv1_id" class="<?php echo $t03_rkas02_add->LeftColumnClass ?>"><?php echo $t03_rkas02->lv1_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t03_rkas02_add->RightColumnClass ?>"><div<?php echo $t03_rkas02->lv1_id->CellAttributes() ?>>
...
<script type="text/javascript">
ft03_rkas02add.CreateAutoSuggest({"id":"x_lv1_id","forceSelect":true});
</script>
...
<?php if ($t03_rkas02->no_urut->Visible) { // no_urut ?>
	<div id="r_no_urut" class="form-group">
		<label id="elh_t03_rkas02_no_urut" for="x_no_urut" class="<?php echo $t03_rkas02_add->LeftColumnClass ?>"><?php echo $t03_rkas02->no_urut->FldCaption() ?></label>
		<div class="<?php echo $t03_rkas02_add->RightColumnClass ?>"><div<?php echo $t03_rkas02->no_urut->CellAttributes() ?>>
...
<?php if ($t03_rkas02->keterangan->Visible) { // keterangan ?>
	<div id="r_keterangan" class="form-group">
		<label id="elh_t03_rkas02_keterangan" for="x_keterangan" class="<?php echo $t03_rkas02_add->LeftColumnClass ?>"><?php echo $t03_rkas02->keterangan->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t03_rkas02_add->RightColumnClass ?>"><div<?php echo $t03_rkas02->keterangan->CellAttributes() ?>>
...
<?php if ($t03_rkas02->jumlah->Visible) { // jumlah ?>
	<div id="r_jumlah" class="form-group">
		<label id="elh_t03_rkas02_jumlah" for="x_jumlah" class="<?php echo $t03_rkas02_add->LeftColumnClass ?>"><?php echo $t03_rkas02->jumlah->FldCaption() ?></label>
		<div class="<?php echo $t03_rkas02_add->RightColumnClass ?>"><div<?php echo $t03_rkas02->jumlah->CellAttributes() ?>>
...
<?php if (!$t03_rkas02_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $t03_rkas02_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t03_rkas02_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
