...
$t04_rkas03_add = NULL; // Initialize page object first

class ct04_rkas03_add extends ct04_rkas03 {
	...
	// Page object name
	var $PageObjName = 't04_rkas03_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("t04_rkas03list.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t04_rkas03view.php")
	...
	function AddRow($rsold = NULL) {
		...
		// lv2_id
		$this->lv2_id->SetDbValueDef($rsnew, $this->lv2_id->CurrentValue, 0, FALSE);
...
// Create page object
if (!isset($t04_rkas03_add)) $t04_rkas03_add = new ct04_rkas03_add();

// Page init
$t04_rkas03_add->Page_Init();

// Page main
$t04_rkas03_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t04_rkas03_add->Page_Render();
?>
...
var CurrentForm = ft04_rkas03add = new ew_Form("ft04_rkas03add", "add");

// Validate form
ft04_rkas03add.Validate = function() {
...
ft04_rkas03add.Form_CustomValidate = 
...
ft04_rkas03add.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ft04_rkas03add.Lists["x_lv1_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_urut","x_keterangan","",""],"ParentFields":[],"ChildFields":["x_lv2_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t02_rkas01"};
ft04_rkas03add.Lists["x_lv1_id"].Data = "<?php echo $t04_rkas03_add->lv1_id->LookupFilterQuery(FALSE, "add") ?>";
ft04_rkas03add.AutoSuggests["x_lv1_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $t04_rkas03_add->lv1_id->LookupFilterQuery(TRUE, "add"))) ?>;
ft04_rkas03add.Lists["x_lv2_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_urut","x_keterangan","",""],"ParentFields":["x_lv1_id"],"ChildFields":[],"FilterFields":["x_lv1_id"],"Options":[],"Template":"","LinkTable":"t03_rkas02"};
ft04_rkas03add.Lists["x_lv2_id"].Data = "<?php echo $t04_rkas03_add->lv2_id->LookupFilterQuery(FALSE, "add") ?>";
ft04_rkas03add.AutoSuggests["x_lv2_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $t04_rkas03_add->lv2_id->LookupFilterQuery(TRUE, "add"))) ?>;
...
<?php $t04_rkas03_add->ShowPageHeader(); ?>
<?php
$t04_rkas03_add->ShowMessage();
?>
<form name="ft04_rkas03add" id="ft04_rkas03add" class="<?php echo $t04_rkas03_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t04_rkas03_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t04_rkas03_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t04_rkas03">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($t04_rkas03_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($t04_rkas03->lv1_id->Visible) { // lv1_id ?>
	<div id="r_lv1_id" class="form-group">
		<label id="elh_t04_rkas03_lv1_id" class="<?php echo $t04_rkas03_add->LeftColumnClass ?>"><?php echo $t04_rkas03->lv1_id->FldCaption() ?></label>
		<div class="<?php echo $t04_rkas03_add->RightColumnClass ?>"><div<?php echo $t04_rkas03->lv1_id->CellAttributes() ?>>
...
<script type="text/javascript">
ft04_rkas03add.CreateAutoSuggest({"id":"x_lv1_id","forceSelect":true});
</script>
...
<?php if ($t04_rkas03->lv2_id->Visible) { // lv2_id ?>
	<div id="r_lv2_id" class="form-group">
		<label id="elh_t04_rkas03_lv2_id" class="<?php echo $t04_rkas03_add->LeftColumnClass ?>"><?php echo $t04_rkas03->lv2_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t04_rkas03_add->RightColumnClass ?>"><div<?php echo $t04_rkas03->lv2_id->CellAttributes() ?>>
...
<script type="text/javascript">
ft04_rkas03add.CreateAutoSuggest({"id":"x_lv2_id","forceSelect":true});
</script>
...
<?php if ($t04_rkas03->no_urut->Visible) { // no_urut ?>
	<div id="r_no_urut" class="form-group">
		<label id="elh_t04_rkas03_no_urut" for="x_no_urut" class="<?php echo $t04_rkas03_add->LeftColumnClass ?>"><?php echo $t04_rkas03->no_urut->FldCaption() ?></label>
		<div class="<?php echo $t04_rkas03_add->RightColumnClass ?>"><div<?php echo $t04_rkas03->no_urut->CellAttributes() ?>>
...
<?php if ($t04_rkas03->keterangan->Visible) { // keterangan ?>
	<div id="r_keterangan" class="form-group">
		<label id="elh_t04_rkas03_keterangan" for="x_keterangan" class="<?php echo $t04_rkas03_add->LeftColumnClass ?>"><?php echo $t04_rkas03->keterangan->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t04_rkas03_add->RightColumnClass ?>"><div<?php echo $t04_rkas03->keterangan->CellAttributes() ?>>
...
<?php if ($t04_rkas03->jumlah->Visible) { // jumlah ?>
	<div id="r_jumlah" class="form-group">
		<label id="elh_t04_rkas03_jumlah" for="x_jumlah" class="<?php echo $t04_rkas03_add->LeftColumnClass ?>"><?php echo $t04_rkas03->jumlah->FldCaption() ?></label>
		<div class="<?php echo $t04_rkas03_add->RightColumnClass ?>"><div<?php echo $t04_rkas03->jumlah->CellAttributes() ?>>
...
<?php if (!$t04_rkas03_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $t04_rkas03_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t04_rkas03_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
