...
//
// Table class for t95_rkas2
//
class ct95_rkas2 extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't95_rkas2';
		$this->TableName = 't95_rkas2';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t95_rkas2`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t95_rkas2', 't95_rkas2', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// no_urut
		$this->no_urut = new cField('t95_rkas2', 't95_rkas2', 'x_no_urut', 'no_urut', '`no_urut`', '`no_urut`', 200, -1, FALSE, '`no_urut`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_urut->Sortable = TRUE; // Allow sort
		$this->fields['no_urut'] = &$this->no_urut;

		// keterangan
		$this->keterangan = new cField('t95_rkas2', 't95_rkas2', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// jumlah
		$this->jumlah = new cField('t95_rkas2', 't95_rkas2', 'x_jumlah', 'jumlah', '`jumlah`', '`jumlah`', 4, -1, FALSE, '`jumlah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jumlah->Sortable = TRUE; // Allow sort
		$this->jumlah->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['jumlah'] = &$this->jumlah;

		// no_keyfield
		$this->no_keyfield = new cField('t95_rkas2', 't95_rkas2', 'x_no_keyfield', 'no_keyfield', '`no_keyfield`', '`no_keyfield`', 200, -1, FALSE, '`no_keyfield`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_keyfield->Sortable = TRUE; // Allow sort
		$this->fields['no_keyfield'] = &$this->no_keyfield;

		// no_level
		$this->no_level = new cField('t95_rkas2', 't95_rkas2', 'x_no_level', 'no_level', '`no_level`', '`no_level`', 16, -1, FALSE, '`no_level`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama_tabel
		$this->nama_tabel = new cField('t95_rkas2', 't95_rkas2', 'x_nama_tabel', 'nama_tabel', '`nama_tabel`', '`nama_tabel`', 200, -1, FALSE, '`nama_tabel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_tabel->Sortable = TRUE; // Allow sort
		$this->fields['nama_tabel'] = &$this->nama_tabel;

		// id_data
		$this->id_data = new cField('t95_rkas2', 't95_rkas2', 'x_id_data', 'id_data', '`id_data`', '`id_data`', 3, -1, FALSE, '`id_data`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t95_rkas2`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "t95_rkas2edit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "t95_rkas2add.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t95_rkas2view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t95_rkas2view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t95_rkas2add.php?" . $this->UrlParm($parm);
		else
			$url = "t95_rkas2add.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t95_rkas2edit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t95_rkas2add.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t95_rkas2delete.php", $this->UrlParm());
	}
