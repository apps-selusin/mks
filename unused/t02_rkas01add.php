...
$t02_rkas01_add = NULL; // Initialize page object first

class ct02_rkas01_add extends ct02_rkas01 {
	...
	// Page object name
	var $PageObjName = 't02_rkas01_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("t02_rkas01list.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t02_rkas01view.php")
...
// Create page object
if (!isset($t02_rkas01_add)) $t02_rkas01_add = new ct02_rkas01_add();

// Page init
$t02_rkas01_add->Page_Init();

// Page main
$t02_rkas01_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t02_rkas01_add->Page_Render();
?>
...
var CurrentForm = ft02_rkas01add = new ew_Form("ft02_rkas01add", "add");

// Validate form
ft02_rkas01add.Validate = function() {
...
ft02_rkas01add.Form_CustomValidate = 
...
ft02_rkas01add.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $t02_rkas01_add->ShowPageHeader(); ?>
<?php
$t02_rkas01_add->ShowMessage();
?>
<form name="ft02_rkas01add" id="ft02_rkas01add" class="<?php echo $t02_rkas01_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t02_rkas01_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t02_rkas01_add->Token ?>">
<?php } ?>
...
<?php if ($t02_rkas01->keterangan->Visible) { // keterangan ?>
	<div id="r_keterangan" class="form-group">
		...
		<div class="<?php echo $t02_rkas01_add->RightColumnClass ?>"><div<?php echo $t02_rkas01->keterangan->CellAttributes() ?>>
...
<?php if ($t02_rkas01->jumlah->Visible) { // jumlah ?>
	<div id="r_jumlah" class="form-group">
		<label id="elh_t02_rkas01_jumlah" for="x_jumlah" class="<?php echo $t02_rkas01_add->LeftColumnClass ?>"><?php echo $t02_rkas01->jumlah->FldCaption() ?></label>
		<div class="<?php echo $t02_rkas01_add->RightColumnClass ?>"><div<?php echo $t02_rkas01->jumlah->CellAttributes() ?>>
...
<?php if (!$t02_rkas01_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $t02_rkas01_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t02_rkas01_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
