...
$t99_audit_trail_add = NULL; // Initialize page object first

class ct99_audit_trail_add extends ct99_audit_trail {
	...
	// Page object name
	var $PageObjName = 't99_audit_trail_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("t99_audit_traillist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t99_audit_trailview.php")
...
// Create page object
if (!isset($t99_audit_trail_add)) $t99_audit_trail_add = new ct99_audit_trail_add();

// Page init
$t99_audit_trail_add->Page_Init();

// Page main
$t99_audit_trail_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t99_audit_trail_add->Page_Render();
?>
...
var CurrentForm = ft99_audit_trailadd = new ew_Form("ft99_audit_trailadd", "add");

// Validate form
ft99_audit_trailadd.Validate = function() {
...
ft99_audit_trailadd.Form_CustomValidate = 
...
ft99_audit_trailadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $t99_audit_trail_add->ShowPageHeader(); ?>
<?php
$t99_audit_trail_add->ShowMessage();
?>
<form name="ft99_audit_trailadd" id="ft99_audit_trailadd" class="<?php echo $t99_audit_trail_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t99_audit_trail_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t99_audit_trail_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t99_audit_trail">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($t99_audit_trail_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($t99_audit_trail->datetime->Visible) { // datetime ?>
	<div id="r_datetime" class="form-group">
		<label id="elh_t99_audit_trail_datetime" for="x_datetime" class="<?php echo $t99_audit_trail_add->LeftColumnClass ?>"><?php echo $t99_audit_trail->datetime->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t99_audit_trail_add->RightColumnClass ?>"><div<?php echo $t99_audit_trail->datetime->CellAttributes() ?>>
...
<?php if ($t99_audit_trail->script->Visible) { // script ?>
	<div id="r_script" class="form-group">
		<label id="elh_t99_audit_trail_script" for="x_script" class="<?php echo $t99_audit_trail_add->LeftColumnClass ?>"><?php echo $t99_audit_trail->script->FldCaption() ?></label>
		<div class="<?php echo $t99_audit_trail_add->RightColumnClass ?>"><div<?php echo $t99_audit_trail->script->CellAttributes() ?>>
...
<?php if ($t99_audit_trail->user->Visible) { // user ?>
	<div id="r_user" class="form-group">
		<label id="elh_t99_audit_trail_user" for="x_user" class="<?php echo $t99_audit_trail_add->LeftColumnClass ?>"><?php echo $t99_audit_trail->user->FldCaption() ?></label>
		<div class="<?php echo $t99_audit_trail_add->RightColumnClass ?>"><div<?php echo $t99_audit_trail->user->CellAttributes() ?>>
...
<?php if ($t99_audit_trail->action->Visible) { // action ?>
	<div id="r_action" class="form-group">
		<label id="elh_t99_audit_trail_action" for="x_action" class="<?php echo $t99_audit_trail_add->LeftColumnClass ?>"><?php echo $t99_audit_trail->action->FldCaption() ?></label>
		<div class="<?php echo $t99_audit_trail_add->RightColumnClass ?>"><div<?php echo $t99_audit_trail->action->CellAttributes() ?>>
...
<?php if ($t99_audit_trail->_table->Visible) { // table ?>
	<div id="r__table" class="form-group">
		<label id="elh_t99_audit_trail__table" for="x__table" class="<?php echo $t99_audit_trail_add->LeftColumnClass ?>"><?php echo $t99_audit_trail->_table->FldCaption() ?></label>
		<div class="<?php echo $t99_audit_trail_add->RightColumnClass ?>"><div<?php echo $t99_audit_trail->_table->CellAttributes() ?>>
...
<?php if ($t99_audit_trail->_field->Visible) { // field ?>
	<div id="r__field" class="form-group">
		<label id="elh_t99_audit_trail__field" for="x__field" class="<?php echo $t99_audit_trail_add->LeftColumnClass ?>"><?php echo $t99_audit_trail->_field->FldCaption() ?></label>
		<div class="<?php echo $t99_audit_trail_add->RightColumnClass ?>"><div<?php echo $t99_audit_trail->_field->CellAttributes() ?>>
...
<?php if ($t99_audit_trail->keyvalue->Visible) { // keyvalue ?>
	<div id="r_keyvalue" class="form-group">
		<label id="elh_t99_audit_trail_keyvalue" for="x_keyvalue" class="<?php echo $t99_audit_trail_add->LeftColumnClass ?>"><?php echo $t99_audit_trail->keyvalue->FldCaption() ?></label>
		<div class="<?php echo $t99_audit_trail_add->RightColumnClass ?>"><div<?php echo $t99_audit_trail->keyvalue->CellAttributes() ?>>
...
<?php if ($t99_audit_trail->oldvalue->Visible) { // oldvalue ?>
	<div id="r_oldvalue" class="form-group">
		<label id="elh_t99_audit_trail_oldvalue" for="x_oldvalue" class="<?php echo $t99_audit_trail_add->LeftColumnClass ?>"><?php echo $t99_audit_trail->oldvalue->FldCaption() ?></label>
		<div class="<?php echo $t99_audit_trail_add->RightColumnClass ?>"><div<?php echo $t99_audit_trail->oldvalue->CellAttributes() ?>>
...
<?php if ($t99_audit_trail->newvalue->Visible) { // newvalue ?>
	<div id="r_newvalue" class="form-group">
		<label id="elh_t99_audit_trail_newvalue" for="x_newvalue" class="<?php echo $t99_audit_trail_add->LeftColumnClass ?>"><?php echo $t99_audit_trail->newvalue->FldCaption() ?></label>
		<div class="<?php echo $t99_audit_trail_add->RightColumnClass ?>"><div<?php echo $t99_audit_trail->newvalue->CellAttributes() ?>>
...
<?php if (!$t99_audit_trail_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $t99_audit_trail_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t99_audit_trail_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
ft99_audit_trailadd.Init();
</script>
<?php
$t99_audit_trail_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t99_audit_trail_add->Page_Terminate();
?>
