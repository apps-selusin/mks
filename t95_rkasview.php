...
$t95_rkas_view = NULL; // Initialize page object first

class ct95_rkas_view extends ct95_rkas {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t95_rkaslist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t95_rkaslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t95_rkas_view)) $t95_rkas_view = new ct95_rkas_view();

// Page init
$t95_rkas_view->Page_Init();

// Page main
$t95_rkas_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t95_rkas_view->Page_Render();
?>
...
var CurrentForm = ft95_rkasview = new ew_Form("ft95_rkasview", "view");

// Form_CustomValidate event
ft95_rkasview.Form_CustomValidate = 
...
ft95_rkasview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($t95_rkas->Export == "") { ?>
<div class="ewToolbar">
<?php $t95_rkas_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t95_rkas_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $t95_rkas_view->ShowPageHeader(); ?>
<?php
$t95_rkas_view->ShowMessage();
?>
<?php if (!$t95_rkas_view->IsModal) { ?>
<?php if ($t95_rkas->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t95_rkas_view->Pager)) $t95_rkas_view->Pager = new cPrevNextPager($t95_rkas_view->StartRec, $t95_rkas_view->DisplayRecs, $t95_rkas_view->TotalRecs, $t95_rkas_view->AutoHidePager) ?>
<?php if ($t95_rkas_view->Pager->RecordCount > 0 && $t95_rkas_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t95_rkas_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t95_rkas_view->PageUrl() ?>start=<?php echo $t95_rkas_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t95_rkas_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t95_rkas_view->PageUrl() ?>start=<?php echo $t95_rkas_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t95_rkas_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t95_rkas_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t95_rkas_view->PageUrl() ?>start=<?php echo $t95_rkas_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t95_rkas_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t95_rkas_view->PageUrl() ?>start=<?php echo $t95_rkas_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t95_rkas_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft95_rkasview" id="ft95_rkasview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t95_rkas_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t95_rkas_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t95_rkas">
<input type="hidden" name="modal" value="<?php echo intval($t95_rkas_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($t95_rkas->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_t95_rkas_id"><?php echo $t95_rkas->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $t95_rkas->id->CellAttributes() ?>>
<span id="el_t95_rkas_id">
<span<?php echo $t95_rkas->id->ViewAttributes() ?>>
<?php echo $t95_rkas->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_rkas->kiri_tabel->Visible) { // kiri_tabel ?>
	<tr id="r_kiri_tabel">
		<td class="col-sm-2"><span id="elh_t95_rkas_kiri_tabel"><?php echo $t95_rkas->kiri_tabel->FldCaption() ?></span></td>
...
<?php echo $t95_rkas->kiri_tabel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_rkas->kiri_id->Visible) { // kiri_id ?>
	<tr id="r_kiri_id">
		<td class="col-sm-2"><span id="elh_t95_rkas_kiri_id"><?php echo $t95_rkas->kiri_id->FldCaption() ?></span></td>
...
<?php echo $t95_rkas->kiri_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_rkas->kiri_lv2->Visible) { // kiri_lv2 ?>
	<tr id="r_kiri_lv2">
		<td class="col-sm-2"><span id="elh_t95_rkas_kiri_lv2"><?php echo $t95_rkas->kiri_lv2->FldCaption() ?></span></td>
...
<?php echo $t95_rkas->kiri_lv2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_rkas->kiri_lv3->Visible) { // kiri_lv3 ?>
	<tr id="r_kiri_lv3">
		<td class="col-sm-2"><span id="elh_t95_rkas_kiri_lv3"><?php echo $t95_rkas->kiri_lv3->FldCaption() ?></span></td>
...
<?php echo $t95_rkas->kiri_lv3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_rkas->kiri_lv4->Visible) { // kiri_lv4 ?>
	<tr id="r_kiri_lv4">
		<td class="col-sm-2"><span id="elh_t95_rkas_kiri_lv4"><?php echo $t95_rkas->kiri_lv4->FldCaption() ?></span></td>
...
<?php echo $t95_rkas->kiri_lv4->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_rkas->kiri_jumlah->Visible) { // kiri_jumlah ?>
	<tr id="r_kiri_jumlah">
		<td class="col-sm-2"><span id="elh_t95_rkas_kiri_jumlah"><?php echo $t95_rkas->kiri_jumlah->FldCaption() ?></span></td>
...
<?php echo $t95_rkas->kiri_jumlah->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_rkas->kanan_tabel->Visible) { // kanan_tabel ?>
	<tr id="r_kanan_tabel">
		<td class="col-sm-2"><span id="elh_t95_rkas_kanan_tabel"><?php echo $t95_rkas->kanan_tabel->FldCaption() ?></span></td>
...
<?php echo $t95_rkas->kanan_tabel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_rkas->kanan_id->Visible) { // kanan_id ?>
	<tr id="r_kanan_id">
		<td class="col-sm-2"><span id="elh_t95_rkas_kanan_id"><?php echo $t95_rkas->kanan_id->FldCaption() ?></span></td>
...
<?php echo $t95_rkas->kanan_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_rkas->kanan_lv2->Visible) { // kanan_lv2 ?>
	<tr id="r_kanan_lv2">
		<td class="col-sm-2"><span id="elh_t95_rkas_kanan_lv2"><?php echo $t95_rkas->kanan_lv2->FldCaption() ?></span></td>
...
<?php echo $t95_rkas->kanan_lv2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_rkas->kanan_lv3->Visible) { // kanan_lv3 ?>
	<tr id="r_kanan_lv3">
		<td class="col-sm-2"><span id="elh_t95_rkas_kanan_lv3"><?php echo $t95_rkas->kanan_lv3->FldCaption() ?></span></td>
...
<?php echo $t95_rkas->kanan_lv3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_rkas->kanan_lv4->Visible) { // kanan_lv4 ?>
	<tr id="r_kanan_lv4">
		<td class="col-sm-2"><span id="elh_t95_rkas_kanan_lv4"><?php echo $t95_rkas->kanan_lv4->FldCaption() ?></span></td>
...
<?php echo $t95_rkas->kanan_lv4->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_rkas->kanan_jumlah->Visible) { // kanan_jumlah ?>
	<tr id="r_kanan_jumlah">
		<td class="col-sm-2"><span id="elh_t95_rkas_kanan_jumlah"><?php echo $t95_rkas->kanan_jumlah->FldCaption() ?></span></td>
...
<?php echo $t95_rkas->kanan_jumlah->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
